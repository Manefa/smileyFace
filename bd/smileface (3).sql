...
--
-- Client :  localhost
-- Généré le :  Jeu 05 Octobre 2023 à 21:03
...
--
ALTER TABLE `event`
  MODIFY `idEv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
...
--
ALTER TABLE `studentsatisfaction`
  MODIFY `idEt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
--
